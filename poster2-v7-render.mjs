...
await page.pdf({
  path: path.join(__dirname, 'linkerdog-a3-poster2-self-intro-v7.pdf'),
  width: '297mm',
  height: '420mm',
...
await page.screenshot({ path: path.join(__dirname, 'linkerdog-a3-poster2-self-intro-v7.png'), fullPage: true });
await browser.close();
console.log('done');

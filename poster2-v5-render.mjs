...
await page.pdf({
  path: path.join(__dirname, 'linkerdog-a3-poster2-self-intro-v5.pdf'),
  width: '297mm',
  height: '420mm',
...
await page.screenshot({ path: path.join(__dirname, 'linkerdog-a3-poster2-self-intro-v5.png'), fullPage: true });
await browser.close();
console.log('done');
